...
import logging
import sys
from src.config import LOGS_DIR, INPUT_FILE, CAPOLOGY_OUTPUT
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOGS_DIR / 'capology_scraper.log'),
...
class CapologyScraper:
    ...
    def run(self, input_file=None):
        ...
        try:
            ...
            # Guardar resultados
            results_df.to_parquet(CAPOLOGY_OUTPUT)
            
            logger.info(f"Datos guardados exitosamente en {CAPOLOGY_OUTPUT}")
